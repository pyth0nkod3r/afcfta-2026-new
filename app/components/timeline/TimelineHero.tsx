        ...
        >
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base text-white/80 sm:text-lg">
              A comprehensive 6-month journey from registration to
              implementation. Experience Africa's premier hackathon through our
              innovative hybrid format connecting participants across the
              continent.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3 max-w-3xl">
            ...
            >
              ...
              <div className="text-xl font-bold">72 Hours</div>
              <div className="text-sm text-white/80">Core Hackathon</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
