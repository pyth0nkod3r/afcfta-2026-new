      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {/* Physical Event */}
            <Card className="border-2 border-white/40 hover:border-white/60 transition-colors bg-white/60">
          ...
          <div className="text-center bg-white/60 rounded-xl p-8 border border-white/40">
