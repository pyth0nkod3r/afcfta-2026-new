...
const examples = [
  {
    icons: [
      <Brain key="ai" className="w-6 h-6 text-white" />,
      <Database key="data" className="w-6 h-6 text-white" />,
    ],
    title: "AI + Open Data",
    description:
  ...
  {
    icons: [
      <Landmark key="customs" className="w-6 h-6 text-white" />,
      <Globe key="value" className="w-6 h-6 text-white" />,
    ],
  ...
  {
    icons: [
      <Users key="sme" className="w-6 h-6 text-white" />,
      <ArrowRightLeft key="payments" className="w-6 h-6 text-white" />,
    ],
...
export function ChallengesTracksCollaboration() {
  return (
    <section className="w-full bg-linear-to-br from-slate-900 via-slate-800 to-slate-700 py-14 sm:py-18">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-3 rounded-full bg-white/10 text-white px-5 py-2 mb-3">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {examples.map((ex, idx) => (
              <motion.div
                ...
                className="flex flex-col items-center justify-center bg-linear-to-br from-purple-300 via-purple-400 to-violet-500 rounded-xl p-5 min-h-[150px] shadow-lg hover:shadow-xl transition-all duration-300"
              >
                <div className="flex items-center gap-2 mb-2">{ex.icons}</div>
